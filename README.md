...
* 状態：未ログインユーザーが画面を表示した
  * 入力エリア
    ...
    * 注力したい思考：任意、テキストエリア
    * 住まいの地域　：必須、「北海道または東北、関東、中部、関西、中国または四国、九州または沖縄」
    * 住まいの気候　：必須、「寒い地域、温かい地域、寒暖差の少ない地域」
    * 同居人　　　　：必須、「1〜15」人暮らし
    * （うち子供）　：必須、「0〜15」人
    * 実施状況　　　：任意、「全て／大半／一部」の生活に関わるモノｘ「かなり／ある程度／ちょっとだけ」減らしている
  * ボタン
...
* 更新通知機能（通知プルダウン、メール通知）
  ...
  * 思考の共有ウォッチ
* ランキング（週間、月間、年間、総合）
  * 経験の投稿x評価機能（いいね数or真似した数）ランキング
  * ユーザー（経験の投稿数ｘ経験コメント数ｘ主張コメント数）ランキング
  * 思考の共有いいね数ランキング
* Twitter連動
  * ログイン連動
  * 投稿連動
...
![経験の投稿 ER図](./doc/table-experience.png "経験の投稿 ER図")

![思考の共有 ER図](./doc/table-idea.png "思考の共有 ER図")
